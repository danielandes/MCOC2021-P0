...
Nombres= ["A_I_d.txt","A_II_d.txt","A_III_d.txt","A_IV_d.txt","A_V_d.txt","A_VI_d.txt","A_VII_d.txt"]
Tiempolimpio=[]
Nlimpio=[]
...
Nombres2= ["A_I_f.txt","A_II_f.txt","A_III_f.txt","A_IV_f.txt","A_V_f.txt","A_VI_f.txt","A_VII_f.txt"]
Tiempolimpio2=[]
Nlimpio2=[]
