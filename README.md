...
* En general las corridas se mantienen estables, se notan algunas diferencias para los ensamblajes de las matrices llenas entre tamaños N=10 a N=100. Tambien se nota en todos los casos que la primera corrida tiene demora abnormalmente alta en comparacion a las otras 9 corridas, atribuido a la asignacion de recursos. Lo cual causaba que el promedio del primer tamaño se desviara demasiado, razon por la cual se decidio omitir este dato abnormal al momento de trazar las lineas de complejidad.
