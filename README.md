...
* En general las corridas se mantienen estables, se notan algunas diferencias para los ensamblajes de las matrices llenas entre tamaños N=10 a N=100. Tambien se nota en todos los casos que las corridas subsecuentes tienen demora abnormalmente alta, atribuido a la reasignacion de recursos tras termianr las corridas. Lo cual causaba que el promedio del primer tamaño se desviara demasiado y no tuviera sentido comparado con los tamaños mayores, razon por la cual se decidio omitir este dato abnormal al momento de trazar las lineas de complejidad.
