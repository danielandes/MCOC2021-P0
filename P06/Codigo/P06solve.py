...
archivo= open("solve_llena.txt", "w+")
for i in range(len(N*10)):
    archivo.write(str(UsoTiempo_ens[i])+" "+str(UsoTiempo_sol[i])+" "+str(Nlista[i])+" "+"\n")
archivo.close()
N2=[2,5,10,20,40,50,80,100,150,200,300,500,1000,2000,3000,4000,5000,6000,7000,9000,10000,15000,20000,30000,40000]
UsoTiempo_ens2=[]
UsoTiempo_sol2=[]
Nlista2=[]
for a in range(10):
...
#Creacion del archivo para guardar datos
archivo= open("solve_dispersa.txt", "w+")
